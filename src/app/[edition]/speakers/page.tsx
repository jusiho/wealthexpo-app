...
export default async function Page({ params }: Props) {
  ...
  const filteredSpeakers = speakers.filter(
    (speaker: any) => speaker.edicion == edition
  );
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6">
          {filteredSpeakers.map((speaker: any) => (
            <div
              key={speaker.id}
              className="w-full bg-white rounded-lg p-4 flex flex-col justify-center items-center"
            >
              <div className="mb-8">
                <Image
                  width={144}
              ...
              {speaker.imagen_empresa && (
                <div className="py-2">
                  <Image
                    src={speaker.imagen_empresa}
                    width={144}
                    height={144}
                    alt="photo"
                  />
              ...
              <div className="flex gap-2 text-white mt-4">
                <Link href={speaker.linkedin} className="bg-black rounded p-2">
                  <svg
                ...
                <Link href={speaker.instagram} className="bg-black rounded p-2">
                  <svg
                    viewBox="0 0 1024 1024"
                    fill="currentColor"
                    height="2em"
